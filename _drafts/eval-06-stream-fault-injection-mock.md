...
<!-- 发布 TODO：更新 date 与文件名前缀；系列区块同步进 1-5；开源后补仓库链接 -->

> **系列 · 我的评测工具链**（持续更新）
>
> 1. [从 trace 到 eval：trace 设计、agent eval 方法论、一个评测 harness 的实现，和它抓到的上游并发 bug](/posts/从-trace-到-eval-trace-设计-Agent-评测方法论-一个评测-harness-的实现-和它抓到的上游并发-bug/)
